  ...
  const handleSubmit = (e) => {
    ...
    if (CheckUserName.test(ChangeValue.username)) {
      if (CheckEmail.test(ChangeValue.email)) {
        ...
        toast(
          "Please write it. E-mail.- Right. e-mail that contains the words yahoo or gmail or hotmail, & It must contain letters only without numbers",
          {
            duration: 5000,
          }
        );
      ...
      toast(
        "Username Must Contain Not More than 8 Characters ,It starts with a big letter and ends with a little letter.",
        {
          duration: 5000,
        }
      );
